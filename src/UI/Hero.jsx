        ...
        <div className="hero__wrapper">
            <div className="hero__content">
                ...
                <div className="hero__btns" data-aos-duration="1200" data-aos="fade-up" data-aos-delay="200">
                    <a href="./registration"><button className='register__btn'>Get Started</button></a>
                    <a href="./programs"><button className='watch_btn'><span><i className="ri-play-fill"></i></span>Watch Video</button></a>
                </div>
            </div>
